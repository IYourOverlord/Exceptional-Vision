...
|---|---|---|
| ev-neoforge | `dev.ev.neoforge`, `dev.ev.neoforge.config` | `EV` (@Mod entrypoint), `EVInstance` (lifecycle), `EVConfig` (immutable validated config record), `EVConfigLoader` (NeoForge ModConfigSpec bridge). |
